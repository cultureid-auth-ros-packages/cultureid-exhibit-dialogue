...
docker-compose -f /home/cultureid_user0/rasa-container/rasa-container-wreath-el/docker-compose.yml up > $rasa_output_file_el 2>&1 &
docker-compose -f /home/cultureid_user0/rasa-container/rasa-container-wreath-en/docker-compose.yml up > $rasa_output_file_en 2>&1 &
